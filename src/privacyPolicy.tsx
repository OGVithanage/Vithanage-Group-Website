        ...
        <div className="w-screen min-h-screen flex flex-col bg-background">
            <main className="flex-1 p-10 flex flex-col items-center">
                <div className="max-w-4xl w-full bg-card p-12 rounded-3xl border border-ring/10 shadow-sm">
                    <h1 className="text-4xl font-extrabold mb-8 text-foreground text-center">Privacy Policy</h1>
                    ...
                    <div className="space-y-10 text-foreground/80 leading-relaxed">
                        ...
                        <section className="bg-white/5 p-8 rounded-2xl border border-white/10">
                            <h2 className="text-2xl font-bold mb-4 text-foreground">Cookies and Tracking Technologies</h2>
                            <p>
                        ...
                        <section className="bg-white/5 p-8 rounded-2xl border border-white/10">
                            <h2 className="text-2xl font-bold mb-4 text-foreground">Changes to the Privacy Policy</h2>
                            <p>
