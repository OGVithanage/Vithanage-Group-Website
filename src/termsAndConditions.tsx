        ...
        <div className="w-screen min-h-screen flex flex-col bg-background">
            <main className="flex-1 p-10 flex flex-col items-center">
                <div className="max-w-4xl w-full bg-card p-12 rounded-3xl border border-ring/10 shadow-sm">
                    <h1 className="text-4xl font-extrabold mb-8 text-foreground text-center">Terms and Conditions</h1>
                    ...
                    <div className="space-y-10 text-foreground/80 leading-relaxed">
                        ...
                        <section className="bg-white/5 p-8 rounded-2xl border border-white/10">
                            <h2 className="text-2xl font-bold mb-4 text-foreground">1. Use of the Website</h2>
                        ...
                        <section className="bg-white/5 p-8 rounded-2xl border border-white/10">
                            <h2 className="text-2xl font-bold mb-4 text-foreground">2. Product Information and Pricing</h2>
                            <ul className="list-disc pl-6 space-y-2">
                        ...
                        <section className="bg-white/5 p-8 rounded-2xl border border-white/10">
                            <h2 className="text-2xl font-bold mb-4 text-foreground">4. Shipping and Delivery</h2>
                            <ul className="list-disc pl-6 space-y-2">
                        ...
                        <section className="bg-primary/10 p-8 rounded-2xl border border-primary/20">
                            <h2 className="text-2xl font-bold mb-4 text-primary">5. Returns and Refunds</h2>
                            <p>
                        ...
                        <section className="bg-white/5 p-8 rounded-2xl border border-white/10">
                            <h2 className="text-2xl font-bold mb-4 text-foreground">8. Amendments and Termination</h2>
                            <p>
