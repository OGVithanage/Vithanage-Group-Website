        ...
        <div className="w-screen min-h-screen flex flex-col bg-background">
            <main className="flex-1 p-6 md:p-10 flex flex-col items-center">
                <div className="max-w-4xl w-full bg-card p-8 md:p-12 rounded-3xl border border-ring/10 shadow-sm">
                    <h1 className="text-3xl md:text-4xl font-extrabold mb-6 md:mb-8 text-foreground text-center">Refund Policy</h1>
                    ...
                    <div className="space-y-8 md:space-y-10 text-foreground/80 leading-relaxed text-sm md:text-base">
                        ...
                        <section className="bg-white/5 p-6 md:p-8 rounded-2xl border border-white/10">
                            <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-foreground">Returns</h2>
                            <p>
                        ...
                        <section className="bg-white/5 p-6 md:p-8 rounded-2xl border border-white/10">
                            <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-foreground">Refunds</h2>
                            <p>
                        ...
                        <section className="bg-primary/10 p-6 md:p-8 rounded-2xl border border-primary/20">
                            <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-primary">Revisions</h2>
                            <p className="text-lg md:text-xl font-medium">
                                We support <span className="font-bold">unlimited revision</span> for the service that we provided.
                            </p>
                        </section>

                        <section className="bg-blue-900/10 p-6 md:p-8 rounded-2xl border border-blue-900/30">
                            <h2 className="text-lg md:text-xl font-bold mb-2 md:mb-3 text-blue-400">Special Note: Technical Errors</h2>
